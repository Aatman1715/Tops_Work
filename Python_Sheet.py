...
#10 - Code to print the number of days in given list of months
...
#11 - Code to print letters and digits in a string
...
# print(f"Digits in the string: {', '.join(digits)}")

#12 - Code to take a number and exponent from user and print the result
